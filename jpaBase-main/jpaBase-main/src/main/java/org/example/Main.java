...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Domicilio dom = new Domicilio("Viamonte" , 1500);

            //CREAR CLIENTE Y SE SETEAN ATRIBUTOS
            Cliente cliente = new Cliente("Josefina" , "Aguiar" , 45617876);
            ...
            //CREAR ARTICULOS
            Articulo articulo1 = new Articulo(100, "Fanta" , 2000);
            Articulo articulo2 = new Articulo(50 , "papitas" , 500);
